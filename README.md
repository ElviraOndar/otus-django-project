...
Бэкенд онлайн-платформы для изучения программирования с поддержкой курсов, уроков и 
...
Фронтенд-часть проекта реализована на Vue 3 + Vite и представляет собой SPA-приложение, которое берет данные из API.
Необходимо установить и запустить SPA, в котором можно будет увидеть главную страницу CodeCourse, а также войти в
личный кабинет от лица студента и от лица преподавателя (логины и пароли для тестов указаны в README.md). 

Подробнее в этом репозитории:

https://github.com/ElviraOndar/code-course-frontend
