...
- Преподаватели 1) могут создавать и редактировать только свои курсы; 2) не могут записываться на курсы.
...
Для создания тестовых пользователей, курсов и уроков выполните:

```bash
python manage.py seed_data
```

Это создаст 2 преподавателей и 6 студентов с простыми паролями. Список их логинов и паролей можно найти в файле test_passwords.txt
